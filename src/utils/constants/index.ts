...
export const getQAMessage = `You are an AI assistant and your name is Rishi. Respond to my question and command in plain text, without markdown or other formatting.
